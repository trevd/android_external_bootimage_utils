...
#define KERNEL_COMPRESSION_TYPE_STRING_UNKNOWN "unknown"
#define KERNEL_COMPRESSION_TYPE_STRING_LZ4 "lz4"
#define KERNEL_COMPRESSION_TYPE_STRING_GZIP "gzip"
#define KERNEL_COMPRESSION_TYPE_STRING_LZOP "lzop"
#define KERNEL_COMPRESSION_TYPE_STRING_BZIP2 "bzip2"
#define KERNEL_COMPRESSION_TYPE_STRING_XZ "xz"
#define KERNEL_COMPRESSION_TYPE_STRING_LZMA "lzma"


static struct kernel_type_t  {
	int compression_type ;
	char* compression_type_string ;
	char* magic ;
	uint32_t magic_size ;
} kernel_type[] = {
	{ KERNEL_COMPRESSION_TYPE_LZ4 , KERNEL_COMPRESSION_TYPE_STRING_LZ4 , KERNEL_COMPRESSION_MAGIC_LZ4 , KERNEL_COMPRESSION_MAGIC_LZ4_SIZE },
	{ KERNEL_COMPRESSION_TYPE_GZIP , KERNEL_COMPRESSION_TYPE_STRING_GZIP , KERNEL_COMPRESSION_MAGIC_GZIP , KERNEL_COMPRESSION_MAGIC_GZIP_SIZE },
	{ KERNEL_COMPRESSION_TYPE_LZOP , KERNEL_COMPRESSION_TYPE_STRING_LZOP , KERNEL_COMPRESSION_MAGIC_LZOP , KERNEL_COMPRESSION_MAGIC_LZOP_SIZE },
	{ KERNEL_COMPRESSION_TYPE_BZIP2 , KERNEL_COMPRESSION_TYPE_STRING_BZIP2 , KERNEL_COMPRESSION_MAGIC_BZIP2 , KERNEL_COMPRESSION_MAGIC_BZIP2_SIZE },
	{ KERNEL_COMPRESSION_TYPE_XZ , KERNEL_COMPRESSION_TYPE_STRING_XZ , KERNEL_COMPRESSION_MAGIC_XZ , KERNEL_COMPRESSION_MAGIC_XZ_SIZE },
	{ KERNEL_COMPRESSION_TYPE_LZMA , KERNEL_COMPRESSION_TYPE_STRING_LZMA , KERNEL_COMPRESSION_MAGIC_LZMA , KERNEL_COMPRESSION_MAGIC_LZMA_SIZE },
	{ KERNEL_COMPRESSION_TYPE_UNKNOWN , KERNEL_COMPRESSION_TYPE_STRING_UNKNOWN , NULL , 0 }
};
