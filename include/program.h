...
#define DEFAULT_KERNEL_IMAGE_NAME               "Image"
#define DEFAULT_KERNEL_CONFIG_GZIP              "config.gz"
#define DEFAULT_KERNEL_CONFIG                   "config"
#define DEFAULT_KERNEL_RAMDISK_IMAGE_NAME       "kernel-initramfs.img"
#define DEFAULT_KERNEL_RAMDISK_CPIO_NAME        "kernel-initramfs.cpio"
#define DEFAULT_KERNEL_RAMDISK_DIRECTORY_NAME   "kernel-initramfs"
